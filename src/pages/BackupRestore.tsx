  ...
  const handleLoadDemoData = async () => {
    try {
      ...
      const demoSetup = {
        ...
        takeProfitModel: 'Next Liquidity Pool',
        minimumRR: 2.0,
        defaultRiskPercent: 1.0,
        rules: ['Trade only during London Open', 'Minimum 2R target'],
        invalidConditions: ['High Impact News', 'No clear draw on liquidity'],
        checklist: [
