...
class SupabaseDatabaseService {
    ...
    return tradesData.map(row => {
      return {
        ...
        planned: {
          ...
          lotSize: row.planned_lot_size ? Number(row.planned_lot_size) : undefined,
        ...
        actual: {
          ...
          lotSize: row.actual_lot_size ? Number(row.actual_lot_size) : undefined,
  ...
  async saveTrade(trade: Trade, userId: string): Promise<Trade> {
    ...
    const tradeRow: Record<string, any> = {
      ...
      planned_lot_size: trade.planned?.lotSize,
      ...
      actual_lot_size: trade.actual?.lotSize,
